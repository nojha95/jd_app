...
def call_openai(jd_text,resume_text):
    ...
    And then under Additional information:
    1. Resume key highlights.
    2. Strengths and Weaknesses of resume based on job description.
    3. A set of interview questions ensuring the questions are relevant and challenging to assess his/her qualifications effectively.
    ...
    5. Culture fit (Keeping in mind company's core values which are GROUND CONNECT, RESULT ORIENTED, EMOTIONAL CONNECT,
      ANALYTICAL and TRENDSETTER: Assess this using extra-curricular activites and intangible skills)
    """
